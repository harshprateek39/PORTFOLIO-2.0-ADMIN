...
const CardProject = ({value ,func,index}) => {
  return (
    <div  onClick={()=>func(index)} className=' snap-start bg-white/30 min-w-[200px]  flex flex-col items-start rounded-md py-2 px-0.5   text-white hover:bg-white/35 cursor-pointer  '>
